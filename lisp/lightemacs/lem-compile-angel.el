;;; lem-compile-angel.el --- lem-compile-angel -*- lexical-binding: t -*-
...
`compile-angel-on-load-mode'."
  ...
  (with-eval-after-load 'savehist
    (lem-compile-angel-exclude savehist-file))
  (with-eval-after-load 'recentf
    (lem-compile-angel-exclude recentf-save-file))
...
;;; lem-compile-angel.el ends here
