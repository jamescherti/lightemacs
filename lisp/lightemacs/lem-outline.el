;;; lem-outline.el --- lem-outline -*- lexical-binding: t -*-
...
(defun lem-outline--set-buffer-local-ellipsis (ellipsis)
...
(defun lem-outline--update-ellipsis ()
  ...
  (unless (or (bound-and-true-p outline-indent-minor-mode)
    ...
    (lem-outline--set-buffer-local-ellipsis lightemacs-ellipsis)))

(add-hook 'outline-minor-mode-hook #'lem-outline--update-ellipsis)
(add-hook 'outline-mode-hook #'lem-outline--update-ellipsis)
