;;; lem-recentf.el --- lem-recentf -*- lexical-binding: t -*-
...
;;
;; In addition to its built-in capabilities, the lem-recentf module provides the
...
(use-package recentf
  ...
  (defun lem-recentf--cleanup-and-save ()
  ...
  :preface
  (defun lem-recentf--track-buffer-change (&rest _args)
  ...
  :config
  (add-hook 'window-buffer-change-functions #'lem-recentf--track-buffer-change)
  ...
  ;; `recentf-save-list'
  (add-hook 'kill-emacs-hook #'lem-recentf--cleanup-and-save -90))
